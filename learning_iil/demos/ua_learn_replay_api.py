...
from learning_iil.learners.parametrizations.tf.uncertainty import FortifiedResnetOneMixture, MonteCarloDropoutResnetOneMixture, \
...
if __name__ == '__main__':
    ...
    print('LEARNING...')
    tf_learner.optimize(observations, actions)
    tf_learner.save()
    print('DONE')
